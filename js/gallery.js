...
const Gallery = (function() {
  ...
  function loadPhotos() {
    ...
    // Use fotos de fallback caso o JSON não carregue
    const fallbackPhotos = [{
      name: "Débora",
      src: "https://i.ibb.co/SxSv6cY/c73b09db7e992cf19e904c273fc0da6a.jpg",
      filter: "debora"
    }, {
      name: "Gustavo",
      src: "https://i.ibb.co/mqzGrSc/1714166687091-2.jpg",
      filter: "gustavo"
    }, {
      name: "Fernanda",
      src: "https://i.ibb.co/TmwLKgd/1717383827414-1.jpg",
      filter: "fernanda"
    }, {
      name: "Akira",
      src: "https://i.ibb.co/0DNJf75/ef03e1e1a7d3041c30a4b248196a0228.jpg",
      filter: "akira"
    }, {
      name: "Leo Oli",
      src: "https://i.ibb.co/gzsg2HL/c1f322153045747e8c0ae38e817867ef.jpg",
      filter: "leooli"
    }, {
      name: "Lisa",
      src: "https://i.ibb.co/s2B7x0K/1715149773368-3.jpg",
      filter: "lisa"
    }, ];
    ...
    $.getJSON(config.photosUrl)
      ...
      .fail(function() {
        console.error('Erro ao carregar fotos. Usando fallback.');
  ...
  function initIsotope() {
    // Apenas inicializa se ainda não foi feito
    if (isotope) {
      return;
    }
    ...
    // Garante que o layout inicial é aplicado
    setTimeout(function() {
  ...
  function initMagnificPopup() {
    ...
    // Inicializa o Magnific Popup para as imagens atualmente visíveis
    $('.grid-item:not(.isotope-hidden) .gallery-link').magnificPopup({
      type: 'image',
      gallery: {
        enabled: true,
